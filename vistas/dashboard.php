        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                <div class="small-box bg-secondary">
                    <div class="inner">
                        <h4 id="totalVentasHoy">$ 250.00</h4>
            ...
            <div class="col-lg-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title" id="card-title-ventas-mes">Ventas del Mes: $ 1,200.00</h3>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                $("#card-title-ventas-mes").html('Ventas del Mes: $ ' + total_ventas_mes.toString().replace(/\d(?=(\d{3})+\.)/g, "$&,"));
            ...
            success: function(respuesta) {
                ...
                for (let i = 0; i < respuesta.length; i++) {
                    filas = '<tr>' +
                        ...
                        '<td class="text-right"> $ ' + respuesta[i]['total_venta'] + '</td>' +
                        '</tr>'
